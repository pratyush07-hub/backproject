...
const loginUser = asyncHandler( async (req, res) => {
    ...
    // username or email
    // find the user if not nai hai user bol dena
    // password check
...
const updateAccountDetails = asyncHandler( async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user, "Account details updateed successfully"))
...
const updateUserAvatar = asyncHandler( async (req, res) => {
    ...
    try {
        ...
        throw new ApiError(400, "oldavatar not found")
    }
...
const getUserChannelProfile = asyncHandler( async (req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        },
        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",        // users me
                foreignField: "channel",  // subscription me kaise dekhu
                as: "subscribers"
            }
        },
        {
        ...
        {
            $addFields: {
                subscribersCount: {        // to evaluate or calculate
                    $size: "$subscribers"
                },
        ...
        {
            $project: {   // kis kis value ko project karna hai
                fullName: 1,
                username: 1,
                subscribersCount: 1,
...
const getWatchHistory = asyncHandler( async (req, res) => {
    const user = await User.aggregate([
        ...
        },
        {
            $lookup: {
                ...
                foreignField: "_id",
                as: "watchHistory",
                pipeline: [  // videos ke andar aagaye  -- sub pipeline
                    {
                        $lookup: {
                            from: "users",
                            localField: "owner",
    ...
    return res.status(200).json(new ApiResponse(200,user[0],"WatchHistory fetched successfully"));
})
